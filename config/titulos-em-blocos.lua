--[[===========================================================================
  ...
  parágrafo com <span class="block-title block-title-N">. Visualmente
  idêntico (ver styles/componentes.scss), mas sem virar slide.
  ...
  for _, bloco in ipairs(blocos) do
    if bloco.t == "Header" then
      local attr = pandoc.Attr(
        bloco.identifier,
        { "block-title", "block-title-" .. tostring(bloco.level) }
      )
